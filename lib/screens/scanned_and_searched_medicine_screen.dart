...
// class ScannedAndSearchedMedicinesScreen extends StatelessWidget {
//   const ScannedAndSearchedMedicinesScreen({super.key});
//   static String scannedSearchedMedicinesScreenId =
//       'ScannedSearchedMedicinesScreen';
//   @override
...
//           if (state is SimilarMedicinesToMedicineMahcineNameLoadingState) {
//             return const CustomCircularIdicator();
//           } else if (state
//               is SimilarMedicinesToMedicineMahcineNameSuccessState) {
//             return Padding(
...
//                       itemCount: state.similarMedicinesList.length,
...
//                             medicineName:
//                                 state.similarMedicinesList[index].medicineName,
//                           );
//                         },
//                         child: Container(
...
//                               children: [
//                                 CachedNetworkImage(
//                                   imageUrl: state.similarMedicinesList[index]
//                                       .medicineImage!,
//                                   width: 110,
//                                   height: 110,
...
//                                     children: [
//                                       Text(
//                                         state.similarMedicinesList[index]
//                                             .medicineName,
...
//                                       ),
//                                       Text(
//                                         "Medicine's Alternatives: ${state.similarMedicinesList[index].medicineAlternative}",
//                                         maxLines: 2,
...
//               ),
//             );
//           } else if (state is SimilarMedicinesToMedicineMahcineNameErrorState) {
//             return Center(
//               child: Text(
//                 state.errorMessage,
